<?php
    ...
    $to             = 'bensmatilyes2011@gmail.com'; //put your email here
    $email_template = 'https://raw.githack.com/lybst/AETemplates/master/cvsimple.html';  // will find it on email-templates/ directory
